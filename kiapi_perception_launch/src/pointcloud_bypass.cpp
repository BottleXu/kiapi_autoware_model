...
namespace kiapi_perception_launch
{

PCLBypassComponent::PCLBypassComponent(const rclcpp::NodeOptions & options)
: Node("kiapi_bypass", options)
{
  ...
  subscription_ =  this->create_subscription<sensor_msgs::msg::PointCloud2>(
    "pointcloud_raw_ex", 
    rclcpp::SensorDataQoS().keep_last(maximum_queue_size_),
    std::bind(&PCLBypassComponent::convert_point_xyzirc, this, std::placeholders::_1));
  
}

void PCLBypassComponent::convert_point_xyzirc(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
{ 
...
RCLCPP_COMPONENTS_REGISTER_NODE(kiapi_perception_launch::PCLBypassComponent)
