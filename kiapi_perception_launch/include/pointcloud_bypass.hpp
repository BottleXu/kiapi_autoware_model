#ifndef KIAPI_PERCEPTION_LAUNCH__POINTCLOUD_BYPASS_HPP_
#define KIAPI_PERCEPTION_LAUNCH__POINTCLOUD_BYPASS_HPP_
...
class PCLBypassComponent : public rclcpp::Node
{
public:
  KIAPI_PERCEPTION_LAUNCH_PUBLIC
  explicit PCLBypassComponent(const rclcpp::NodeOptions & options);
...
#endif  // KIAPI_PERCEPTION_LAUNCH__POINTCLOUD_BYPASS_HPP_
