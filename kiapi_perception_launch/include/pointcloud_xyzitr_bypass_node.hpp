...
{
public:
  explicit PCLConvertXYZITRNode(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
...
private:
  ...
  void convert_point_xyzitr(const sensor_msgs::msg::PointCloud2::SharedPtr msg);
