...
def launch_setup(context, *args, **kwargs):
    ...
    #         plugin="kiapi_infrastructure::PCLSyncNode",
    #         name="kiapi_hesai_sync",
    #         extra_arguments=[{"use_intra_process_comms": LaunchConfiguration("use_intra_process")}],
    #     )
    # )
...
def generate_launch_description():
    ...
    common_sensor_share_dir = get_package_share_directory("kiapi_infrastructure_sensor_kit_launch")
    ...
    add_launch_arg("frame_id", "hesai_lidar", "frame id")
